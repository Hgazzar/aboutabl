      ...
      >
        <Box sx={{ width: "50%" }}>
          <div className="flex flex-col gap-0 mb-4 h-16">
            ...
            <p className="text-dark font-semibold mt-1">{data?.matherNameEN}</p>
          </div>
          <div className="flex flex-col gap-0 mb-4 h-16">
            <label className="text-sm font-semibold mb-1 text-gray">
              Email
            </label>
            <p className="text-dark font-semibold mt-1">{data?.matherEmail}</p>
          </div>
          <div className="flex flex-col gap-0 mb-4 h-16">
            <label className="text-sm font-semibold mb-1 text-gray">
              Job title
            </label>
            <p className="text-dark font-semibold mt-1">{data?.matherJob}</p>
          </div>
        </Box>
        <Box sx={{ width: "50%" }}>
          <div className="flex flex-col gap-0 mb-4 h-16">
            <label className="text-sm font-semibold mb-1 text-gray">ID</label>
            <p className="text-dark font-semibold mt-1">{data?.matherNID}</p>
          </div>
          <div className="flex flex-col gap-0 mb-4 h-16">
            <label className="text-sm font-semibold mb-1 text-gray">
              Phone
            </label>
            <p className="text-dark font-semibold mt-1">{data?.matherPhone}</p>
          </div>
        </Box>
      </Box>
    </Box>
