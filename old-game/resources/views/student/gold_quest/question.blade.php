                ...
                @if (count($game->questions) > 0)
                    ...
                    <div class="answers">
                        ...
                        <div class="answerCard" id="answerCard1"
                             onclick="answer_gold_quest_question('{{ $game->questions[0]->answer1 }}', 1)">
                        ...
                        <div class="answerCard" id="answerCard2"
                             onclick="answer_gold_quest_question('{{ $game->questions[0]->answer2 }}', 2)">
                            @if($game->questions[0]->answer_type == 'text')
                        ...
                        <div class="answerCard" id="answerCard3"
                             onclick="answer_gold_quest_question('{{ $game->questions[0]->answer3 }}', 3)">
                            @if($game->questions[0]->answer_type == 'text')
                        ...
                        <div class="answerCard" id="answerCard4"
                             onclick="answer_gold_quest_question('{{ $game->questions[0]->answer4 }}', 4)">
                            @if($game->questions[0]->answer_type == 'text')
...
@section('scripts')
    ...
    <script src="{{ asset('js/student/gold_quest.js') }}"></script>
    <script>
        ...
        if (localStorage.getItem("current_question") && (parseInt(localStorage.getItem("current_question")) + 1) !== questions.length) {
            ...
            $('#question_data').append(`
                    ...
                    <div class="answers">
                        ...
                        <div class="answerCard" id="answerCard1" onclick="answer_gold_quest_question('${questions[parseInt(question_num)].answer1}', 1)">${question1}</div>
                        <div class="answerCard" id="answerCard2" onclick="answer_gold_quest_question('${questions[parseInt(question_num)].answer2}', 2)">${question2}</div>
                        <div class="answerCard" id="answerCard3" onclick="answer_gold_quest_question('${questions[parseInt(question_num)].answer3}', 3)">${question3}</div>
                        <div class="answerCard" id="answerCard4" onclick="answer_gold_quest_question('${questions[parseInt(question_num)].answer4}', 4)">${question4}</div>
                    </div>
                    <div id="show_correct_answer">
                    </div>
                `)
