    ...
    <main>
        <div class="container">
            <div class="Questions">
                ...
                <div class="answers chooseBox">
                    <div class="answerCard chooseBoxcard">
                        <img
                            src="{{ asset('assets/images/treasure1.png') }}"
                            alt=""
                            class="answerImage"
                        />
                    </div>
                    <div class="answerCard chooseBoxcard">
                        <img
                            src="{{ asset('assets/images/treasure2.png') }}"
                            alt=""
                            class="answerImage"
                        />
                    </div>
                    <div class="answerCard chooseBoxcard">
                        <img
                            src="{{ asset('assets/images/treasure3.png') }}"
                            alt=""
                            class="answerImage"
                        />
                    </div>
