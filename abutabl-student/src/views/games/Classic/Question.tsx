...
export default function InteractiveQuestion() {
	...
	const { mm, ss, clearCountdown } = useGameCountdown(gameId, game?.time, onExpire);
	...
	const logoSrc = gameLogoSrc(game?.logo, '/assets/games/images/animalTestImg.png');
