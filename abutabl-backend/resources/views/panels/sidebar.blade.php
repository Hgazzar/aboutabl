    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="/home">
                    ...
                    <h2 class="brand-text mb-0" style="color:#132C50"><img style="width:75%"  src="{{ asset('images/pages/login.png') }}" alt="branding logo"></h2>
                </a></li>
            ...
            @foreach($menuData[0]->menu as $menu)
                ...
                @else
                  ...
                  <li class="nav-item {{ (request()->is($menu->url)) ? 'active' : '' }} {{ $custom_classes }}">
                        <a href="{{ $menu->url }}">
                            <i class="{{ $menu->icon }}"></i>
                            <span class="menu-title" data-i18n="{{ $translation }}"> @lang($menu->name) </span>
                            @if (isset($menu->badge))
