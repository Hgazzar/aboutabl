            ...
            <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav">
                        <!--<li class="nav-item d-none d-lg-block"><a class="nav-link bookmark-star"><i class="ficon feather icon-star warning"></i></a>-->
                            <div class="bookmark-input search-input">
                                ...
                                <input class="form-control input" type="text" placeholder="{{__('main.search')}}" tabindex="0" data-search="laravel-starter-list" />
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <!--<i class="flag-icon flag-icon-{{ str_replace('_', '-', app()->getLocale()) == 'ar' ? 'eg' : 'us'  }}"></i><span class="selected-language">{{ str_replace('_', '-', app()->getLocale()) == 'ar' ? __('main.Arabic') :  __('main.English') }}</span></a>-->
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            <a class="dropdown-item" href="/welcome/en" data-language="en"><i class="flag-icon flag-icon-us"></i> {{__('main.English')}}</a>
                            <a class="dropdown-item" href="/welcome/ar" data-language="ar"><i class="flag-icon flag-icon-eg"></i>  {{__('main.Arabic')}}</a>
                        </div>
                    </li>
                    ...
                    <!--<li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon feather icon-search"></i></a>-->
                        <div class="search-input">
                            ...
                            <input class="input" type="text" placeholder="{{__('main.search')}}" tabindex="-1" data-search="starter-list" />
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{auth()->user()->full_name}}</span><span class="user-status">{{auth()->user()->username}}</span></div><span><img class="round" src=" @if(auth()->user()->avater) {{asset('images/portrait/small/avatar-s-1.jpg') }} @else {{asset('images/portrait/small/avatar-s-11.jpg') }} @endif" alt="avatar" height="40" width="40" /></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('logout') }}"><i class="feather icon-power"></i> {{__('main.Logout')}}</a>
                        </div>
                    </li>
                </ul>
            </div>
