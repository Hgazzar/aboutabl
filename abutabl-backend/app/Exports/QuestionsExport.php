 ...
 /**
   ...
   public function collection()
   {
        ...
        $question =  Questions::where('status','1');
               ...
               if(request()->has('id'))
                 $question = $question->whereIN('id',request('id'));
   ...
   public function headings(): array
   {
       ...
       return [
          "id", "subject", "unit","lesson","type","code","question","corAnswer","reasoning","reasoningIsRequired","answer1","answer2","answer3","answer4","answer5","answer6","answer7","answer8","answer2.1","answer2.2","answer2.3","answer2.4","answer2.5","answer2.6","answer2.7","answer2.8"
         ];
   }
}
